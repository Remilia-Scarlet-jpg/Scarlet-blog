...
/**
 * 红魔馆博客 - 数据库工具 (H2 内嵌版 · Render 部署用)
 * 无需外部 MySQL，首次启动自动建表并插入示例数据
 */
public class DBUtil {

    private static final String URL = "jdbc:h2:file:/tmp/scarlet_blog;MODE=MySQL;DATABASE_TO_LOWER=TRUE";
    ...
    private static void initDatabase() {
        try (Connection conn = DriverManager.getConnection(URL, USER, PASS);
            ...
            // 检查是否已初始化
            ResultSet rs = stmt.executeQuery("SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='POSTS'");
            rs.next();
            ...
            stmt.execute("INSERT INTO posts (title, content, excerpt, author, category_id, tags, view_count) VALUES " +
                ...
                "('完美红茶的冲泡方法 - 咲夜的下午茶时间', '<h2>🫖 咲夜的完美红茶冲泡法</h2><p>为了大小姐，我一直在冲泡完美的红茶。</p><h3>所需物品</h3><ol><li>最顶级的红茶叶</li><li>新鲜的泉水</li><li>银制茶壶</li><li>白瓷茶杯</li><li>操纵时间的能力（这是必须的）</li></ol><h3>步骤</h3><p>先将茶壶温热，放入茶叶。注入沸腾的热水，<strong>恰好等待3分钟</strong>——即便暂停了时间，也要遵守红茶的萃取时间。</p><p>以完美的温度呈给大小姐。这就是我的职责。</p><p class=\"signature\">—— 十六夜 咲夜</p>', '红魔馆的女仆长十六夜咲夜教你如何为大小姐冲泡完美红茶。', '十六夜 咲夜', 3, '红茶,兴趣,咲夜,完美', 215)," +
            ...
            // 种子数据 - 用户
            stmt.execute("INSERT INTO users (username, password, nickname, role) VALUES " +
                "('remilia', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', '蕾米莉亚·斯卡雷特', '馆主')," +
                "('sakuya', '4827ccf06c94eb067a4884dfa5a6d1a61f2ca2f26a173c358495edb47a174e29', '十六夜 咲夜', '女仆长')");
